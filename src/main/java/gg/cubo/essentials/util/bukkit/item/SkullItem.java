...
import gg.cubo.essentials.util.bukkit.ReflectionUtil;
...
public class SkullItem {
    ...
    public static ItemStack getByUrl(@NotNull String url) {
        return getByUrl(url, base, true);
    }

    @NotNull
    public static ItemStack getByUrl(@NotNull String url, ItemStack base, boolean searchCache) {
    ...
    public static ItemStack getByName(@NotNull String name) {
        return getByName(name, base);
    }

    @NotNull
    public static ItemStack getByName(@NotNull String name, @NotNull ItemStack base) {
    ...
    static {
        try {
            Class<?> skullMeta = ReflectionUtil.getOBClass("inventory.CraftMetaSkull");
